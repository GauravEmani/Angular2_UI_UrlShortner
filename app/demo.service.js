System.register(["@angular/core", "@angular/http", "rxjs/Rx"], function (exports_1, context_1) {
    ...
    var core_1, http_1, Rx_1, DemoService;
    return {
        setters: [
            function (core_1_1) {
                core_1 = core_1_1;
        ...
        execute: function () {
            DemoService = (function () {
                ...
                DemoService.prototype.getStatistics = function () {
                    return this.http.get('http://localhost:8080/statistic/121').map(function (res) { return res.json(); });
                };
                ...
                DemoService.prototype.createFood = function (food) {
                    ...
                    return this.http.post('http://localhost:8080/accounts/', body, options).map(function (res) { return res.json(); });
                };
                DemoService.prototype.registerUrl = function (url) {
                    var headers = new http_1.Headers({ 'Content-Type': 'application/json' });
                    var options = new http_1.RequestOptions({ headers: headers });
                    var body = JSON.stringify(url);
                    // Note: This is only an example. The following API call will fail because there is no actual API to talk to.
                    return this.http.post('http://localhost:8080/register/', body, options).map(function (res) { return res.json(); });
                };
                DemoService.prototype.updateFood = function (food) {
                    ...
                    var body = JSON.stringify(food);
                    // Note: This is only an example. The following API call will fail because there is no actual API to talk to.
                    return this.http.put('/api/food/' + food.id, body, options).map(function (res) { return res.json(); });
                };
